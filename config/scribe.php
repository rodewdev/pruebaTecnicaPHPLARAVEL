...
return [
    ...
    'description' => 'API RESTful para gestión de usuarios y transacciones financieras con validaciones, seguridad y optimización de consultas.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Debes obtener un token de autenticación mediante el endpoint `/api/login` y luego incluirlo en todas las solicitudes a endpoints protegidos.',
    ],
    ...
    'intro_text' => <<<INTRO
        ...
        <aside>A medida que desplazas la página, verás ejemplos de código para trabajar con la API en diferentes lenguajes de programación en el área oscura a la derecha (o como parte del contenido en dispositivos móviles).
    ...
    // Note: does not work for `external` docs types
    'last_updated' => 'Última actualización: {date:j F Y}',
